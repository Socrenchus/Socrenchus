  ...
  (function($, window, document) {
    ...
    LinkPanel = (function(_super) {
      ...
      function LinkPanel() {
        ...
        this.hide = __bind(this.hide, this);
        return LinkPanel.__super__.constructor.apply(this, arguments);
      }
    ...
    VideoPanel = (function(_super) {
      ...
      function VideoPanel() {
        return VideoPanel.__super__.constructor.apply(this, arguments);
      }
    ...
    return Plugin = (function() {
      ...
      Plugin.prototype.init = function() {
        ...
        return post.click(function() {
          ...
          if (!($.trim(text.val()) === '')) {
            ...
            collapse.click();
            if (_this.options.removeOnSubmit) {
      ...
      Plugin.prototype.removeAllPanels = function() {
        var panel, removedPanels, _i, _j, _len, _len1, _ref;
        removedPanels = [];
        _ref = this.panelList;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          panel = _ref[_i];
        ...
        for (_j = 0, _len1 = removedPanels.length; _j < _len1; _j++) {
