    ...
    */
    ...
    PostView = (function(_super) {
      ...
      PostView.prototype.setSiblingTags = function() {
        var sibling, siblings, tag, taglist, _j, _len1, _results;
        ...
        for (_j = 0, _len1 = siblings.length; _j < _len1; _j++) {
          ...
          if (taglist) {
            _results.push((function() {
              ...
              _results1 = [];
              for (_k = 0, _len2 = taglist.length; _k < _len2; _k++) {
                tag = taglist[_k];
                if (this.siblingtags.indexOf(tag) < 0) {
                  _results1.push(this.siblingtags.push(tag));
                } else {
      ...
      PostView.prototype.render = function() {
        var postcontent, t, tag, taglist, tags, vote, _j, _len1, _ref1;
        ...
        if (postcontent.posttext !== '') {
          ...
          $(this.el).find('#votebox:first').votebox({
            vote: vote,
            votesnum: (_ref1 = this.model.get('score')) != null ? _ref1 : '',
      ...
      PostView.prototype.addChild = function(child, tagsToOrderBy) {
        var base, childtags, indexOfTag, newtagdiv, root, tag, tagdiv, _j, _len1, _results;
        if (tagsToOrderBy == null) {
          tagsToOrderBy = [];
        }
        if ((this.model.depth() % App.maxlevel) === (App.maxlevel - 1)) {
          ...
          _results = [];
          for (_j = 0, _len1 = childtags.length; _j < _len1; _j++) {
            tag = childtags[_j];
    ...
    StreamView = (function(_super) {
      ...
      StreamView.prototype.addOne = function(item) {
        var child, children, mychild, post, _j, _k, _len1, _len2;
        post = item.view;
                if (post != null) {
          post;
        ...
        for (_j = 0, _len1 = children.length; _j < _len1; _j++) {
          child = children[_j];
          if (this.user['email'] === child.get('author')['email']) {
            mychild = child;
          }
        }
        for (_k = 0, _len2 = children.length; _k < _len2; _k++) {
          child = children[_k];
          if (child.view === void 0) {
            child.view = this.makeView(child);
          }
      ...
      StreamView.prototype.render = function() {
        ...
        if (!this.streamviewRendered) {
          ...
          $.getJSON('/notifications', (function(data) {
            var message, messages, notification, _j, _len1, _ref1;
            _this.notifications = data;
            messages = [];
            _ref1 = _this.notifications;
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
              notification = _ref1[_j];
              message = "";
